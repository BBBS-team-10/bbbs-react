              ...
              <ul className="menu__list">
                ...
                <li className="menu__list-item menu__dropdown-item">
                  ...
                  <ul className="menu__dropdown-list">
                    ...
                    <li className="menu__dropdown-list-item">
                      <a href="./articles.html" className="link menu__dropdown-link">
                        Статьи
                      </a>
                    </li>
                    <li className="menu__dropdown-list-item">
              ...
              <article className="card card_color_green stub">
                ...
                <div className="stub__content">
                  <h2 className="section-title stub__text">
                    Наставники.про – цифоровая информационная платформа огрганизации «Старшие Братья
                ...
                <div className="card__content">
                  ...
                  <div className="card__annotation card__annotation_position_main-card">
                    <p className="paragraph card__paragraph">
                      Аннотация статьи в несколько абзацев. В тот момент, как ребёнок научился
                    ...
                    <p className="paragraph card__paragraph">
                      Аннотация статьи в несколько абзацев. В тот момент, как ребёнок научился
                      говорить, и не одно слово, а задавать бесконечное количество вопросов, жизнь
                      меняется. Вы будете не по Аннотация статьи в несколько абзацев. В тот момент,
                      как ребёнок научился говорить, и не одно слово, а задавать бесконечное
          ...
          <nav className="footer__column footer__column_content_info">
            <ul className="footer__column-list">
              <li className="footer__column-links">
                <a href="./about.html" className="footer__column-link" target="_self">
                  о проекте
                </a>
              </li>
              <li className="footer__column-links">
                <a href="./calendar.html" className="footer__column-link" target="_self">
                  календарь
                </a>
              </li>
              <li className="footer__column-links">
                <a href="./place.html" className="footer__column-link" target="_self">
                  куда пойти
                </a>
              </li>
              <li className="footer__column-links">
                <a href="./questions.html" className="footer__column-link" target="_self">
                  вопросы
                </a>
              </li>
              <li className="footer__column-links">
                <a href="./read-watch-main.html" className="footer__column-link" target="_self">
                  читать и смотреть
                </a>
              </li>
              <li className="footer__column-links">
                <a href="./rights.html" className="footer__column-link" target="_self">
                  права детей
                </a>
              </li>
              <li className="footer__column-links">
                <a href="./stories.html" className="footer__column-link" target="_self">
                  истории
                </a>
              </li>
            </ul>
