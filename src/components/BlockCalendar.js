    ...
    <article className="calendar main-calendar">
      <div className="calendar__caption">
        ...
        <div className="calendar__about">
          <h2 className="section-title calendar__title">Субботний meet up: учимся проходить интевью</h2>
      ...
      <div className="calendar__meetup">
        ...
        <div className="calendar__submit">
          <button className="button button_theme_light calendar__button_action_sign-up" type="button">
            Записаться
          </button>
